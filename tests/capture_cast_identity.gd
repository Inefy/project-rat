...
const NOTES := ["EARS / SCARF / BLASTER", "WINGS / QUIFF / BEAK", "BELLY / CHEEKS / CURL", "ROUND / DISKS / TUFTS", "COIL / S-NECK / HOOD", "MASK / STRIPES / LID", "LONG LEGS / HUGE TAIL", "CROWN / CAPE / MAGENTA", "SQUARE / JOWLS / SPIKES", "HEART / WINGS / GOWN"]
