...
September 7 playability pass: buffered dash input with current-frame aiming and a local recharge ring; pickups latch onto the rat and follow through escapes; starting seeds deal 11.5 damage every 0.15 seconds, replacing slower, stronger seeds with a rapid rhythm; Snack Wizard activates immediately; drops have a six-kill drought limit; streaks decay gradually and award Rapid Claws at x8 once per wave. Waves contain fewer enemies, health grows more gently, draft recovery takes 0.65s, and ranged stragglers approach faster. Deferred wave-clear loot is banked. Smoke, fun systems, playability, and art suites passed on Godot 4.7.2; browser export and start/combat/draft/pause flow were checked locally. These are balance hypotheses pending human playtesting.
