...
const NOTES := ["EARS / SCARF / BLASTER", "WINGS / QUIFF / BEAK", "GREEN EYES / HANDS / BLADE", "FOUR WINGS / HUMAN NAVEL", "COIL / S-NECK / HOOD", "MASK / STRIPES / LID", "HUMAN EARS / SLEEPY EYES", "CROWN / CAPE / MAGENTA", "SQUARE / JOWLS / SPIKES", "HEART / WINGS / GOWN"]
